...
pub fn insert_items(connection: &mut Connection, items: Vec<Item>) -> CoreResult<()> {
...
pub fn get_items_by_class(connection: &Connection, class: Class) -> CoreResult<Vec<Item>> {
